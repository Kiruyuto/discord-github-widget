...
internal static class ApplicationConfiguration
{
    ...
    public const string SourceCodeFooter = "-# Source code for the app is [available on GitHub](https://github.com/Kiruyuto/discord-github-widget)";
    ...
    {
        public const string SetupName = "setup";
        public const string SetupManualName = "setup-manual";
        public const string InviteName = "invite";
    }
}